...
mkdir airgap
wget -nc https://github.com/k3s-io/k3s/releases/download/v1.30.2%2Bk3s1/k3s-airgap-images-amd64.tar.gz -P ./airgap/
wget -nc https://github.com/k3s-io/k3s/releases/download/v1.30.2%2Bk3s1/k3s -P ./airgap/
